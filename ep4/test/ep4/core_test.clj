...
(deftest RemoveRedundantValuesTest
  (let
   [grammar0 [["S" ["a"]]
    ...
    expectec_result0 [["S" ["a"]]]

    expectec_result1 [["S" ["a"]]
                      ["S" ["B"]]]
...
(deftest GetSymbolToSwapTest
  (let
   [grammar [["S0" ["A", "S", "A"]]
    ...
    expectec_grammar_result_0 [["S0" ["A", "S", "A"]]
                               ["S0" ["a", "B"]]
                               ["S0" ["a"]]
                               ["S0" ["S", "A"]]
                               ["S0" ["A", "S"]]
    ...
    expectec_grammar_result_1 [["S0" ["A", "S", "A"]]
                               ["S0" ["a", "B"]]
                               ["S0" ["a"]]
                               ["S0" ["S", "A"]]
                               ["S0" ["A", "S"]]
...
(deftest PerformeChomskyNormalizationTest
  (let
   [grammar0 [["S" ["A", "S", "A"]]
    ...
    expectec_grammar_result0 [["S0" ["A", "B1"]]
                              ["S0" ["B11", "B"]]
                              ["S0" ["a"]]
                              ["S0" ["A", "S"]]
                              ["S0" ["S", "A"]]
    ...
    expectec_grammar_result1 [["S" ["B", "B111"]]
                              ["B" ["b"]]
                              ["B1" ["a"]]
                              ["B11" ["d"]]
                              ["B111" ["B1", "B11"]]]
    ...
    expectec_grammar_result2 [["S0" ["A" "B11"]]
                              ["S0" ["b"]]
                              ["S0" ["B1" "B"]]
                              ["S" ["A" "B11"]]
                              ["S" ["b"]]
