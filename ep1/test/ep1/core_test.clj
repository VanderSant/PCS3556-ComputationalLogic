...
(deftest CreateRTest []
  (let [
      result (ep1.core/CreateR [1 1 2 3] [1 2 3 1])
    ]
...
(deftest CreateBinaryMatrixTest []
  (let [
      result (ep1.core/CreateBinaryMatrix 3 [[1 1] [1 2] [2 3] [3 1]] )
    ]
...
(deftest GetBinatyMatrixIndexTest []
  (let [
      result0 (ep1.core/GetBinatyMatrixIndex 
          3 [[1 1 0],[0 0 1],[1 0 0]] 
        )
...
(deftest GetTransitiveRTest []
  (let [
      result0 (ep1.core/GetTransitiveR 
